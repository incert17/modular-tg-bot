...
/**
 * Main Bot class with enhanced callback queries, inline keyboards, message editing, and inline queries
 */
class Bot {
    /**
    ...
    async handleInlineQuery(query) {
        try {
            ...
            // Log inline query with proper structure
            logger.logBotActivity('Inline query received', {
                query: query.query,
                userId: query.from.id,
